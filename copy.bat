...
if exist "%BASE_PATH%\%INCLUDE_DIR%\Stronghold_LIB_GM.mqh" copy /Y "%BASE_PATH%\%INCLUDE_DIR%\Stronghold_LIB_GM.mqh" "%INCLUDE_DIR%"
if exist "%BASE_PATH%\%INCLUDE_DIR%\Stronghold_LIB_ST.mqh" copy /Y "%BASE_PATH%\%INCLUDE_DIR%\Stronghold_LIB_ST.mqh" "%INCLUDE_DIR%"
if exist "%BASE_PATH%\%INCLUDE_DIR%\Stronghold_LIB_TM.mqh" copy /Y "%BASE_PATH%\%INCLUDE_DIR%\Stronghold_LIB_TM.mqh" "%INCLUDE_DIR%"
